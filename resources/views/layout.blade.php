                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="col-sm-6">
                                    <h1><span>F</span>-Fruit</h1>
                                    <h2>Quality Food Online Today!</h2>
                                    <p>Order the product and it will immediately be delivered directly to your home.  </p>
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="companyinfo">
                            <h2><span>Fruit</span>-shop</h2>
                            <p>Chào mừng bạn đến với shop hoa quả FruitShop</p>
                        </div>
                    </div>
                    <div class="col-sm-7">
                        <div class="col-sm-3">
