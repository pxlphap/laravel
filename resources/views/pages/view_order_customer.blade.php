@extends('layout')
@section('content')
<h2 class="title text-center" style="margin-top: 50px;">Chi tiết đơn hàng của bạn</h2>
...
<div class="table-agile-info">
  <div class="panel panel-default">
    ...
    color: red;"><b>Ghi chú đơn hàng:</b> {{$order_by_id->shipping_note}}</span>
     <br><span style="margin: 15px 10px 0;
    display: inline-block;
...
<a class="btn btn-default" href="{{URL::to('/customer/' . $customer_id)}} ">Quay lại</a>
@endsection