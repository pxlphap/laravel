	...
	<div class="payment-options">
		...
		<form action="{{ URL::to('save-order') }}" method="POST" id="order-form">
			...
			<span>
				...
				<input name="coupon" id="coupon" type="text" placeholder="Mã giảm giá"></label>
				<div id="coupon-result"></div>	
				<h3 id="total">Tổng: {{ Cart::total(0) . " VND" }}</h3>
			</span>
			
			
			<input style="margin: 20px 10px 0 0;" type="submit" class="btn btn-primary sm-10" value="Đặt hàng">
		</form>
