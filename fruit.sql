...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th9 24, 2023 lúc 02:27 PM
...
(2, 'Giảm 10k', 'giam10k', 987, 10000, 2, NULL, NULL),
(3, 'giảm 10%', 'giam10%', 997, 10, 1, NULL, NULL);
...
(53, 2, 48, 61, '59400', '3', '2023-09-23 21:01:43', NULL),
(54, 2, 49, 62, '297000', '3', '2023-09-23 21:04:16', NULL),
(55, 2, 50, 63, '79200000', '3', '2023-09-23 22:01:45', NULL),
(56, 2, 51, 64, '23000', '2', '2023-09-24 06:07:58', NULL);
...
(65, 53, 42, 'Nước cam ép', '30000', 2, '2023-09-23 21:01:43', NULL),
(66, 54, 37, 'Thịt Trâu Gác Bếp', '300000', 1, '2023-09-23 21:04:16', NULL),
(67, 55, 19, 'Bò Kobe', '80000000', 1, '2023-09-23 22:01:45', NULL),
(68, 56, 42, 'Nước cam ép', '30000', 1, '2023-09-24 06:07:58', NULL);
...
(61, '1', 'Đang chờ xử lý', '2023-09-23 21:01:43', NULL),
(62, '1', 'Đang chờ xử lý', '2023-09-23 21:04:16', NULL),
(63, '2', 'Đã giao', '2023-09-23 22:01:45', NULL),
(64, '1', 'Đang chờ xử lý', '2023-09-24 06:07:58', NULL);
...
(42, 1, 5, 'Nước cam ép', '30000', 'Nước cam hay nước cam ép, nước cam vắt là một loại thức uống phổ biến được làm từ cam bằng cách chiết xuất nước từ trái cam tươi bằng việc vắt hay ép thành một loại nước cam tươi Đối với các sản phẩm nước cam được sản xuất theo công nghiệp, nước cam được chế biến có cho thêm các chất phụ gia,bảo quản rồi đóng chai hoặc ...', 'Nước cam ép là nguồn cung cấp vitamin C, chất chống oxy hóa và khoáng chất quan trọng. Cam ép giúp tăng cường hệ miễn dịch, tăng sức đề kháng và giúp cơ thể hấp thụ chất dinh dưỡng tốt hơn. Nước cam ép cũng giúp cải thiện sức khỏe tim mạch và làm tăng sự tươi trẻ cho da.', 'shipping69.jpg', 1, NULL, NULL, 384);
...
(48, 'Bui Van Phap', 'Hưng Yên', '0383848623', 'pxlphap@gmail.com', 'adf', NULL, NULL),
(49, 'Bui Van Phap', 'Hưng Yên', '0383848623', 'pxlphap@gmail.com', 'sd', NULL, NULL),
(50, 'Bui Van Phap', 'Hưng Yên', '0383848623', 'pxlphap@gmail.com', 'qư', NULL, NULL),
(51, 'Bui Van Phap', 'Hưng Yên', '0383848623', 'pxlphap@gmail.com', 'Đóng gói cẩn thận', NULL, NULL);
...
--
ALTER TABLE `tbl_order`
  MODIFY `order_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT cho bảng `tbl_order_details`
--
ALTER TABLE `tbl_order_details`
  MODIFY `order_details_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT cho bảng `tbl_payment`
--
ALTER TABLE `tbl_payment`
  MODIFY `payment_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `tbl_shipping`
  MODIFY `shipping_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
